        ...
        >
          ...
          <div className="card-body">
            ...
            <div>
              ...
              {/* A simple calculator made with HTML, CSS, JS, React.JS & Tailwind.css */}
            </div>
            <div className="card-actions justify-end">
              <button
                className={`btn ${
                  project.git ? "btn-primary" : "btn-disabled"
                }`}
              >
              ...
              <button
                className={`btn ml-2 ${
                  project.direction ? "btn-primary" : "btn-disabled"
                }`}
              >
                <a href={project.direction} target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="32"
                    height="32"
